...
export interface SubTask {
  ...
  // Phase & Context (COO perspective)
  phase: TaskPhase;
  owner: string; // Who is responsible (role, not person)
  stakeholders: string[]; // Who needs to be consulted/informed
  ...
  // Success Criteria (COO perspective)
...
// =============================================================================
// PROJECT SUB-TASKS
// Detailed sub-task breakdown for each project - COO PERSPECTIVE
// Covers full execution lifecycle: Discovery → Planning → Development → Testing → Training → Rollout → Monitoring
// =============================================================================

import { getProjectSubTasksCOO } from './subtasks-coo';

export function getProjectSubTasks(): ProjectSubTasks[] {
  // Use the comprehensive COO-level sub-tasks
  return getProjectSubTasksCOO();
}

// NOTE: Legacy developer-focused sub-tasks have been replaced by comprehensive
// COO-level sub-tasks in src/lib/subtasks-coo.ts
