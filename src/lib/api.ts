...
// =============================================================================
// 🚀 GROWTH HACKS
// Strategic growth initiatives organized by tier
// =============================================================================
...
export interface GrowthHack {
  ...
  name: string;
  description: string;
  tier: 'Tier 1: Must Build' | 'Tier 2: High Impact' | 'Tier 3: Quick Wins';
  tierOrder: number;
  cacImpact: string;
  buildTime: string;
  dataSources: string[];
...
export function getGrowthHacks(): GrowthHack[] {
  return [
    // TIER 1: MUST BUILD (Weeks 1-4)
    {
      id: 'programmatic-seo',
      name: 'Programmatic Municipality SEO Pages',
      description: 'Generate 8,000+ SEO pages for Spanish municipalities. Target "placas solares [municipio]" with zero competition.',
      tier: 'Tier 1: Must Build',
      tierOrder: 1,
      cacImpact: '-60%',
      buildTime: '30 days',
      dataSources: ['PVGIS API', 'ESIOS API', 'INE Data', 'Municipal websites'],
      requiresApi: ['pvgis-integration', 'esios-integration', 'municipal-incentives'],
      keyBenefit: '90%+ of municipalities have ZERO solar pages',
      urgency: 'Start with 500 top municipalities, scale to 8,000+',
      status: 'Not Started',
    },
    {
      id: 'pvpc-widget',
      name: 'Live PVPC Savings Widget',
      description: 'Real-time widget showing current electricity prices and solar savings. Viral sharing mechanism.',
      tier: 'Tier 1: Must Build',
      tierOrder: 2,
      cacImpact: '-40%',
      buildTime: '7 days',
      dataSources: ['ESIOS/REE API'],
      requiresApi: ['esios-integration'],
      keyBenefit: 'Spaniards check electricity prices obsessively',
      urgency: 'Build standalone microsite first, embed everywhere',
      status: 'Not Started',
    },
    {
      id: 'whatsapp-bot',
      name: 'WhatsApp Pre-Qualification Bot',
      description: 'GDPR-compliant bot that collects 5 key data points and scores leads A/B/C in 2 minutes.',
      tier: 'Tier 1: Must Build',
      tierOrder: 3,
      cacImpact: '-50%',
      buildTime: '14 days',
      dataSources: ['WhatsApp Business API', 'Claude API'],
      requiresApi: ['whatsapp-conversation-history', 'consent-tracking'],
      keyBenefit: '90% WhatsApp open rate vs 15% email',
      urgency: 'Template messages first, add AI responses later',
      status: 'Not Started',
    },
    {
      id: 'irpf-calculator',
      name: 'IRPF 60% Tax Deduction Calculator',
      description: 'Interactive calculator showing exact tax savings. Most Spaniards DON\'T KNOW this exists.',
      tier: 'Tier 1: Must Build',
      tierOrder: 4,
      cacImpact: '-30%',
      buildTime: '3 days',
      dataSources: ['IRPF rules', 'Tax bracket data'],
      requiresApi: [],
      keyBenefit: 'Urgency trigger: expires Dec 31, 2025',
      urgency: '⚠️ 60% deduction ENDS Dec 31, 2025 - then drops to 20-40%',
      status: 'Not Started',
    },
    ...
    {
      id: 'gmb-automation',
      name: 'Google Business Multi-Location',
      description: 'Automate 50+ GMB profiles for service areas. Dominate local pack results.',
      tier: 'Tier 2: High Impact',
      tierOrder: 5,
      cacImpact: '-45%',
      buildTime: '14 days',
      dataSources: ['GMB API', 'Service area data'],
      requiresApi: [],
      keyBenefit: 'Local pack = highest intent clicks at €0 cost',
      status: 'Not Started',
    },
    {
      id: 'review-generation',
      name: 'Review Generation & Auto-Reply',
      description: 'Automated review requests after installation + AI-powered review responses within 2 hours.',
      tier: 'Tier 2: High Impact',
      tierOrder: 6,
      cacImpact: '-25%',
      buildTime: '7 days',
      dataSources: ['Opportunities data', 'GMB API', 'WhatsApp'],
      requiresApi: ['opportunity-stage-timestamps'],
      keyBenefit: 'Spanish trust: Reviews > Ads',
      status: 'Not Started',
    },
    {
      id: 'unified-quote-api',
      name: 'Unified Quote Calculator API',
      description: 'Single source of truth for all pricing. Every touchpoint calls this API.',
      tier: 'Tier 2: High Impact',
      tierOrder: 7,
      cacImpact: '-35%',
      buildTime: '21 days',
      dataSources: ['PVGIS', 'ESIOS', 'Equipment pricing', 'Municipal incentives'],
      requiresApi: ['pvgis-integration', 'esios-integration', 'municipal-incentives'],
      keyBenefit: 'Consistency = Trust = Conversions',
      status: 'Not Started',
    },
    {
      id: 'competitor-intel',
      name: 'Competitor Ad Intelligence Agent',
      description: 'Daily scraping of competitor ads from Meta/Google. AI analysis of gaps and opportunities.',
      tier: 'Tier 2: High Impact',
      tierOrder: 8,
      cacImpact: '-20%',
      buildTime: '7 days',
      dataSources: ['Meta Ad Library', 'Google Ads Transparency'],
      requiresApi: [],
      keyBenefit: 'Avoid wasted ad spend on losing angles',
      status: 'Not Started',
    },

    // TIER 3: QUICK WINS (Can build in 1 week)
    {
      id: 'robinson-suppressor',
      name: 'Robinson/Stop Publicidad Suppressor',
      description: 'Automated nightly suppression against Robinson list. CLI registration for 2025 compliance.',
      tier: 'Tier 3: Quick Wins',
      tierOrder: 9,
      cacImpact: 'Compliance',
      buildTime: '3 days',
      dataSources: ['Robinson List API'],
      requiresApi: ['robinson-list', 'consent-tracking'],
      keyBenefit: 'Avoid €40k-€300k fines',
      urgency: '⚠️ 2025 regulations: unregistered CLI = call blocking',
      status: 'Not Started',
    },
    {
      id: 'consent-vault',
      name: 'Lead Consent Vault System',
      description: 'Store consent evidence for every contact. GDPR Article 21 compliance.',
      tier: 'Tier 3: Quick Wins',
      tierOrder: 10,
      cacImpact: 'Compliance',
      buildTime: '7 days',
      dataSources: ['Lead forms', 'WhatsApp messages'],
      requiresApi: ['consent-tracking'],
      keyBenefit: 'Prove explicit consent for every contact',
      status: 'Not Started',
    },
    {
      id: 'serp-gap-miner',
      name: 'SERP Gap Miner Agent',
      description: 'Find uncontested SEO keywords. Daily automated opportunity discovery.',
      tier: 'Tier 3: Quick Wins',
      tierOrder: 11,
      cacImpact: '-30%',
      buildTime: '7 days',
      dataSources: ['Google SERP', 'People Also Ask'],
      requiresApi: [],
      keyBenefit: '20-50 new content opportunities per day',
      status: 'Not Started',
    },
  ];
}
